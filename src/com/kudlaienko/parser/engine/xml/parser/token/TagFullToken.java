 ...
 */
public class TagFullToken extends XmlToken<String, Tag> {
    ...
    final private Parser<String, List<Attribute>> attributeListToken;
    ...
    private int parseAttributes(String content, int start, TagBuilder tagBuilder) throws ParseException {
        final Integer parserPos[] = {start};
        attributeListToken.isParsable(content, start, parserResult -> {
            parserPos[0] = parserResult.getParserPos();
            tagBuilder.setAttributes(parserResult.getValue());
        });
    ...
    public TagFullToken(Parser<String, String> tagTextToken, Parser<String, String> tagCloseWithNameToken, Parser<String, Bracket> tagCloseBracketToken, Parser<String, String> tagOpenNameToken, Parser<String, List<Attribute>> attributeListToken, Parser<String, String> commentToken) {
        ...
        this.attributeListToken = attributeListToken;
